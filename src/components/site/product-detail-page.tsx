...
function buildProductParagraphs(product: ProductDetailPage) {
  return [
    `${product.shortDescription} Serigrafi baskıda doğru ürün seçimi yalnızca ürün adını bilmekle sınırlı değildir; baskı yüzeyi, kuruma yöntemi, baskı adedi, renk beklentisi, kalıp yapısı ve nihai kullanım şartları birlikte değerlendirilmelidir. ${product.focusKeyword} için ürün seçerken bu değişkenleri birlikte düşünerek atölyenizin çalışma düzenine uygun tedarik planını oluşturabilirsiniz.`,
